    ...
    <div className="relative flex items-center">
      <div className="relative">
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="absolute -inset-px z-0 rounded-full bg-gradient-to-r from-green-500 via-green-500 to-green-500 opacity-30 blur-xl"
        />
        <motion.div
          variants={createVariants({ scale: 1.08, delay: 0.1 })}
          initial="initial"
          animate="animate"
          className="relative z-0 min-h-[80px] min-w-[80px] rounded-full border bg-gradient-to-b from-white to-green-50 shadow-xl shadow-green-500/20"
        >
          <motion.div
            variants={createVariants({ scale: 1.06, delay: 0.2 })}
            initial="initial"
            animate="animate"
            className="absolute inset-1 rounded-full bg-gradient-to-t from-green-500 via-green-500 to-green-500 p-0.5 shadow-xl"
          >
            <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-black/40 shadow-xs shadow-white/40 will-change-transform">
              ...
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="absolute inset-0 rounded-full bg-gradient-to-t from-green-500 via-green-500 to-green-500 opacity-50 shadow-[inset_0_0_16px_4px_rgba(0,0,0,1)]"
              />
              <motion.div
