...
export const SVGMap = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M342.5 28L85 -1"
        className="animate-dashesReverse stroke-green-400/30"
        strokeWidth="1"
...
const GradientColors = () => {
  return (
    <>
      <stop stopColor="#1a9e5c" stopOpacity="0" />
      <stop offset="0.325" stopColor="#1a9e5c" />
      <stop offset="1" stopColor="#1a9e5c" stopOpacity="0" />
    </>
  )
}
